...
class NonLifeInsuranceEditor extends PolymerElement {
...
`;
    ...
    static get is() {
        return 'non-life-insurance-editor';
    }
...
customElements.define(NonLifeInsuranceEditor.is, NonLifeInsuranceEditor);
