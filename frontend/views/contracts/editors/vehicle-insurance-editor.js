...
class VehicleInsuranceEditor extends PolymerElement {
...
<vaadin-form-layout>
 <vaadin-form-layout>
  ...
  <vaadin-text-field label="ŠPZ auta" placeholder="ŠPZ" id="numberOfVehicle"></vaadin-text-field>
 </vaadin-form-layout>
 <vaadin-form-layout>
...
`;
    ...
    static get is() {
        return 'vehicle-insurance-editor';
    }
...
customElements.define(VehicleInsuranceEditor.is, VehicleInsuranceEditor);
