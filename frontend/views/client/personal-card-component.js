...
<vaadin-form-layout style="width: 100%; height: 100%;">
 <vaadin-vertical-layout style="flex-grow: 0; flex-shrink: 1; align-self: flex-start;">
  ...
  <vaadin-upload id="uploadFrontSide" style="align-self: center;" max-files="1"></vaadin-upload>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout style="align-self: flex-start;">
  ...
  <vaadin-upload id="uploadBackSide" style="align-self: center;" max-files="1"></vaadin-upload>
 </vaadin-vertical-layout>
</vaadin-form-layout>
`;
    }
