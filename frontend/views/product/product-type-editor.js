...
<vaadin-form-layout>
 <vaadin-text-field label="Názov typu produktu" placeholder="Názov" id="name"></vaadin-text-field>
 <vaadin-select id="category" label="Kategória" placeholder="Kategória"></vaadin-select>
</vaadin-form-layout>
