...
//            this.companyController.getProductTypeFilter().setName(event.getValue());
...
//            this.companyController.getProductTypeFilter().setIco(event.getValue());
//            this.companyController.filterDataInTable();
//        });
...
//            this.companyController.getProductTypeFilter().setAddress(event.getValue());
//            this.companyController.filterDataInTable();
//        });
