...
public class NonLifeInsuranceDeleteEvent extends NonLifeInsuranceEditorEvent
{

    public NonLifeInsuranceDeleteEvent(NonLifeInsuranceEditor source, NonLifeInsuranceDto nonLifeInsuranceDto, List<FileWrapper> attachments) {
