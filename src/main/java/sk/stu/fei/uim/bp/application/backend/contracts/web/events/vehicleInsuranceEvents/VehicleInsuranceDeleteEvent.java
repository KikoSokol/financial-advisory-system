...
public class VehicleInsuranceDeleteEvent extends VehicleInsuranceEditorEvent
{

    public VehicleInsuranceDeleteEvent(VehicleInsuranceEditor source, VehicleInsuranceDto vehicleInsuranceDto, List<FileWrapper> attachments) {
